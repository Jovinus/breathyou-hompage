...
export const content = {
  ko: {
    ...
    hero: {
      ...
      visual: {
        ...
        processing: 'MediPipe 구조화',
        processingMeta: '수작업 3분 → 자동화 2초',
        output: 'DeepBreath CDSS',
        risk: '5년 후 악화 위험',
        riskValue: '고위험',
        explain: '판단 근거를 함께 보여주는 SHAP 리포트',
      },
    },
    problem: {
      eyebrow: '왜 지금인가',
    ...
    solution: {
      ...
      workflow: [
        { no: '01', title: '결과지 입력', text: '병원에 쌓인 종이·PDF 폐기능검사 결과를 불러옵니다.' },
        { no: '02', title: '데이터 구조화', text: 'MediPipe가 OCR과 NLP로 표준화된 데이터로 변환합니다.' },
        { no: '03', title: '위험도 예측', text: 'DeepBreath가 5년 궤적과 판단 근거를 함께 제시합니다.' },
      ],
      products: [
        {
          name: 'MediPipe',
  ...
  en: {
    ...
    hero: {
      ...
      visual: {
        label: 'Pulmonary-data workflow',
        live: 'Product preview',
        input: 'Pulmonary-test PDF',
        inputMeta: 'Paper and PDF results',
        processing: 'MediPipe structuring',
        processingMeta: '3 minutes manual → 2 seconds',
        output: 'DeepBreath CDSS',
        risk: '5-year deterioration risk',
        riskValue: 'High risk',
        explain: 'SHAP report showing the rationale',
      },
    },
    problem: {
      eyebrow: 'Why now',
    ...
    solution: {
      ...
      workflow: [
        { no: '01', title: 'Import results', text: 'Bring in pulmonary-test results stored as paper or PDF.' },
        { no: '02', title: 'Structure data', text: 'MediPipe converts them into standardized data with OCR and NLP.' },
        { no: '03', title: 'Predict risk', text: 'DeepBreath presents a 5-year trajectory with its rationale.' },
      ],
      products: [
        {
          name: 'MediPipe',
    ...
    market: {
      ...
      panelLabel: 'Go-to-market',
      panelTitle: 'From a global market to the first foothold',
      items: [
        {
          tier: 'TAM',
          value: '~KRW 65T',
